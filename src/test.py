...
def arg_parse():
    ...
    parser.add_argument("--input", dest = 'input', help = 
                        ...
                        default = "../../data/checkin1107_small.avi", type = str)
    parser.add_argument("--output", dest = 'output', help = "Output Video", default = "../../data/checkin_out.avi", type = str)
    ...
    if len(bounding_boxes) != 0:
        ...
        for t in deleted:
            if len(t.features) > 20:
                # matcher.update([np.mean(track.features,axis=0)], [t.track_id])
