'''
Align face with minimal distortion
...
class AbstractAligner(metaclass=ABCMeta):
    def __init__(self):
        pass
...
class AlignCustom(AbstractAligner):
    def __init__(self):
        pass
    ...
    def align(self, img, landmarks, desired_size, padding=0.2):
        """
